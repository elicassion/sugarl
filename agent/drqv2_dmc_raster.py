...
class DrQV2Agent:
    def __init__(self, obs_shape, action_shape, device, lr, feature_dim,
        ...
        self.sensory_action_set = sensory_action_set
        self.sensory_action_idx = 0
    ...
    def get_sensory_action(self, batch_size=1):
        # batch size = 1 if env_num = 1
        sensory_action = [self.sensory_action_set[self.sensory_action_idx]]
        self.sensory_action_idx += 1
        self.sensory_action_idx %= len(self.sensory_action_set)
    ...
    def act(self, obs, step, eval_mode=None):
        ...
        processed_action = {
            ...
            "sensory_action": self.get_sensory_action()
        }
...
if __name__ == "__main__":
    ...
    sensory_action_x_set = list(range(0, observ_x_max+1, sensory_action_step[0]))[:args.sensory_action_x_size]
    sensory_action_y_set = list(range(0, observ_y_max+1, sensory_action_step[1]))[:args.sensory_action_y_size]
    ...
    drq_agent = DrQV2Agent(
        ...
        sensory_action_set=sensory_action_set
    )
    ...
    rb = NstepRewardReplayBuffer(
        ...
        action_space=envs.single_action_space["motor_action"],
        device=device,
